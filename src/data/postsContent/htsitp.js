...
const Data = {
        ...
        {
            type: "p",
            content: "Okay, so you’ve chosen a programming language to learn. Day by day, you’re enlarging your knowledge. What do you have to do now? One of your top priorities now is to train as much as possible."
        },
        {
            type: "p",
        ...
        {
            type: "p",
            content: "Gathering knowledge is one of the most important parts of programming. Knowing more and more, you’re capable of building more advanced applications. However, coding knowledge is not the only skill to master. You should also develop your so-called soft skills."
        },
        {
            type: "p",
            content: "You may be confused why. Well, there is a good reason for that. You won’t achieve much only by yourself. Sometimes you need someone to help you, the other time someone needs you. And the most important thing – how will you work in a company if you don’t have any social skills? Do you think you can build a vast app without having a well-organised team in a short time? I don’t think so. Hence, it’s important to create a programming community around you."
        },
        {
            type: "p",
            content: "With the help of other people, you’ll have a chance to develop your coding skills faster and more effectively. You don’t have a clue how to solve a problem? You can ask a friend to help you. Do you plan to build a profitable app? Why don’t you invite a trusted programmer mate to do it with you? As you can see, having a group of programming friends can boost your projects."
        },
        {
            type: "p",
        ...
        {
            type: "p",
            content: "Grand, but where can you find such friends? There are plenty of options. For example, you can join one of the programming groups on social media. It’s a good place to exchange your knowledge with others or ask for help. Other possible choices are programming portals like Stack Overflow. Their advantage is that you’ll find it easy to get some help there. And, last but not least, what about your real-life mates from school, university, and so on? Try to find some programming passionates among them. I’m sure it can be beneficial for every one of you."
        },
        {
            type: "image",
